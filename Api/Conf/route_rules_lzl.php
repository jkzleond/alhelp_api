...
return array(
    ...
    "v1/upload/[:type]" => "Upload/file", //POST:上传文件
	...
	"v1/talks/list/follow$" => "Talks/talk_follow_list_get", //获取我的粉丝说说列表
	"v1/talks/list/:uid/page/:page" => "Talks/talk_list_get", //获取某人说说列表/所有列表
	"v1/talks/list/:uid" => "Talks/talk_list_get", //获取某人说说列表/所有列表

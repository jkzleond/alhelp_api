...
empty($__FILE__) && $__FILE__ = pathinfo(__FILE__, PATHINFO_DIRNAME);

require_once $__FILE__ . "/WxPay.Exception.php";

require_once $__FILE__ . "/WxPay.Config.php";

require_once $__FILE__ . "/WxPay.Data.php";
...
class WxPayApi {
	...
	private static function postXmlCurl($xml, $url, $useCert = false, $second = 30) {
		...
		if ($useCert == true) {
			...
			curl_setopt($ch, CURLOPT_SSLCERT, pathinfo(__FILE__, PATHINFO_DIRNAME) . WxPayConfig::SSLCERT_PATH);
			curl_setopt($ch, CURLOPT_SSLKEYTYPE, 'PEM');
			curl_setopt($ch, CURLOPT_SSLKEY, pathinfo(__FILE__, PATHINFO_DIRNAME) . WxPayConfig::SSLKEY_PATH);
		}
		//post提交方式
